...
public final class SoundReader {
    public static SoundData read(URL var0) {
        ...
        while (var3 >= 0) {
            int var15 = 0;
            try {
                for (var15 = 0; var15 < var2.length && (var3 = var12.readPcm(var2, var15, var2.length - var15)) > 0; var15 += var3) {
                }
            }
            ...
            while (var16 < var15) {
                ...
                for (int var9 = 0; var9 < var4; ++var9) {
                    var8 += var2[var16++] << 8 | var2[var16++] & 0xFF;
                }
                if (var6 == var5.length) {
                    short[] var18 = var5;
        ...
        IdentificationHeader var13 = var12.getIdentificationHeader();
        return new SoundData(var5, var13.getSampleRate());
    }
}
