...
public final class FrustrumImpl
extends Frustrum {
    ...
    public static Frustrum update() {
        ...
        FrustrumImpl.instance.projectionBuff.clear();
        ...
        FrustrumImpl.normalize(var0.frustrum, 0);
        ...
        FrustrumImpl.normalize(var0.frustrum, 1);
        ...
        FrustrumImpl.normalize(var0.frustrum, 2);
        ...
        FrustrumImpl.normalize(var0.frustrum, 3);
        ...
        FrustrumImpl.normalize(var0.frustrum, 4);
        ...
        FrustrumImpl.normalize(var0.frustrum, 5);
        return instance;
    }
    ...
    private static void normalize(float[][] var0, int var1) {
        ...
        float[] arrf = var0[var1];
        arrf[0] = arrf[0] / var2;
        float[] arrf2 = var0[var1];
        arrf2[1] = arrf2[1] / var2;
        float[] arrf3 = var0[var1];
        arrf3[2] = arrf3[2] / var2;
        float[] arrf4 = var0[var1];
        arrf4[3] = arrf4[3] / var2;
    }
}
