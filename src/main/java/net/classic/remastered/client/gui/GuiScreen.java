...
extends Screen {
    ...
    public void render(int var1, int var2) {
        for (int var3 = 0; var3 < this.buttons.size(); ++var3) {
            ...
            if (!var10000.visible) continue;
            FontRenderer var8 = var7.fontRenderer;
            GL11.glBindTexture(3553, var7.textureManager.load("/gui/gui.png"));
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            int var9 = 1;
            boolean bl = var6 = var1 >= var4.x && var2 >= var4.y && var1 < var4.x + var4.width && var2 < var4.y + var4.height;
            if (!var4.active) {
                var9 = 0;
            } else if (var6) {
                var9 = 2;
            ...
            if (!var4.active) {
                GuiScreen.drawCenteredString(var8, var4.text, var4.x + var4.width / 2, var4.y + (var4.height - 8) / 2, -6250336);
                continue;
            }
            if (var6) {
                GuiScreen.drawCenteredString(var8, var4.text, var4.x + var4.width / 2, var4.y + (var4.height - 8) / 2, 0xFFFFA0);
                continue;
            }
            GuiScreen.drawCenteredString(var8, var4.text, var4.x + var4.width / 2, var4.y + (var4.height - 8) / 2, 0xE0E0E0);
        }
    }
    ...
    protected void onMouseClick(int var1, int var2, int var3) {
        if (var3 == 0) {
            for (var3 = 0; var3 < this.buttons.size(); ++var3) {
                Button var4;
                Button var7 = var4 = (Button)this.buttons.get(var3);
                if (!var4.active || var1 < var7.x || var2 < var7.y || var1 >= var7.x + var7.width || var2 >= var7.y + var7.height) continue;
    ...
    public static void drawBox(int var0, float y, int var2, float f, int var4) {
    }
}
