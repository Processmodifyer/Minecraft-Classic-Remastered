...
public final class FontRenderer {
    ...
    private void render(String var1, int var2, int var3, int var4, boolean var5) {
        if (var1 != null) {
            ...
            for (int var8 = 0; var8 < var12.length; ++var8) {
                int var9;
                if (var12[var8] == '&' && var12.length > var8 + 1) {
                ...
                float var13 = 7.99f;
                var6.vertexUV(var2 + var7, (float)var3 + var13, 0.0f, (float)var4 / 128.0f, ((float)var9 + var13) / 128.0f);
                var6.vertexUV((float)(var2 + var7) + var13, (float)var3 + var13, 0.0f, ((float)var4 + var13) / 128.0f, ((float)var9 + var13) / 128.0f);
                var6.vertexUV((float)(var2 + var7) + var13, var3, 0.0f, ((float)var4 + var13) / 128.0f, (float)var9 / 128.0f);
                var6.vertexUV(var2 + var7, var3, 0.0f, (float)var4 / 128.0f, (float)var9 / 128.0f);
    ...
    public static String stripColor(String var0) {
        ...
        for (int var2 = 0; var2 < var3.length; ++var2) {
            ...
            var1 = String.valueOf(var1) + var3[var2];
        }
        return var1;
    }
