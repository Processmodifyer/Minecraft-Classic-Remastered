...
extends GuiScreen {
    ...
    public final void render(int var1, int var2) {
        OptionsScreen.drawFadingBox(0, 0, this.width, this.height, 0x60050500, -1607454624);
        OptionsScreen.drawCenteredString(this.fontRenderer, this.title, this.width / 2, 20, 0xFFFFFF);
