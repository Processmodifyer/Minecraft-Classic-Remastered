...
extends GuiScreen {
    ...
    public final void render(int var1, int var2) {
        ...
        CraftingScreen.drawFadingBox(this.width / 2 - 120, 30, this.width / 2 + 120, 180, -1878719232, -1070583712);
        if (var1 >= 0) {
            var2 = this.width / 2 + var1 % 9 * 24 + -108;
            int var3 = this.height / 2 + var1 / 9 * 24 + -60;
            CraftingScreen.drawFadingBox(var2 - 3, var3 - 8, var2 + 23, var3 + 24 - 6, -1862270977, -1056964609);
        }
        CraftingScreen.drawCenteredString(this.fontRenderer, "Craft item", this.width / 2, 40, 0xFFFFFF);
