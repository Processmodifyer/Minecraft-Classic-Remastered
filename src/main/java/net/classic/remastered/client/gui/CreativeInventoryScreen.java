...
public final class CreativeInventoryScreen
extends GuiScreen {
    public CreativeInventoryScreen() {
        this.grabsMouse = true;
    }

    private int getBlockOnScreen(int var1, int var2) {
        for (int i = 0; i < InventoryValues.allowedBlocks.size(); ++i) {
            int var3 = this.width / 3 + i % 13 * 24 - 156 - 3;
            int var4 = this.height / 3 + i / 13 * 24 - 80 + 3;
    ...
    public final void render(int var1, int var2) {
        ...
        CreativeInventoryScreen.drawFadingBox(this.width / 2 - 204, 10, this.width / 2 + 168, 204, -1878719232, -1070583712);
        if (var1 >= 0) {
            var2 = this.width / 2 + var1 % 13 * 24 - 156;
            int var3 = this.height / 2 + var1 / 13 * 24 - 80;
            CreativeInventoryScreen.drawFadingBox(var2 - 3, var3 - 8, var2 + 23, var3 + 24 - 6, -1862270977, -1056964609);
        }
        CreativeInventoryScreen.drawCenteredString(this.fontRenderer, "Inventory", this.width / 2, 20, 0xFFFFFF);
