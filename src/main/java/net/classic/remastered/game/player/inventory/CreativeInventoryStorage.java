...
public final class CreativeInventoryStorage {
    public static List<Block> allowedBlocks = new ArrayList<Block>();
    public static List allowedItems;
    ...
    static {
        ...
        allowedBlocks.add(Block.REDSTONE_ORE);
        allowedBlocks.add(Block.IRON_BLOCK);
        allowedBlocks.add(Block.GOLD_BLOCK);
        allowedBlocks.add(Block.REDSTONE_BLOCK);
        ...
        allowedBlocks.add(Item.APPLE);
        allowedBlocks.add(Item.FEATHER);
        allowedBlocks.add(Block.WEB);
    }

    public CreativeInventoryStorage(String var1, String var2) {
        this.username = var1;
        this.sessionId = var2;
    }
}
