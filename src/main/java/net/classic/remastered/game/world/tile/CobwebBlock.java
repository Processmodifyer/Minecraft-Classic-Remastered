...
{
    protected CobwebBlock(final int var1, final int var2, final float width) {
        super(var1);
        this.textureId = var2;
        this.setPhysics(true);
        final float var3 = 0.5f;
        this.setBounds(0.5f - width, 0.0f, 0.5f - width, width + 0.5f, 1.0f, width + 0.5f);
    }
    ...
    private void render(final ShapeRenderer var1, final float var2, final float var3, final float var4) {
        ...
        for (int var12 = 0; var12 < 2; ++var12) {
            float var13 = (float)(MathHelper.sin(var12 * 3.1415927f / 2.0f + 0.7853982f) * 0.7);
            float var14 = (float)(MathHelper.cos(var12 * 3.1415927f / 2.0f + 0.7853982f) * 0.7);
    ...
    public final void renderPreview(final ShapeRenderer var1) {
        ...
        var1.begin();
        this.render(var1, 0.0f, 0.0f, -0.3f);
        var1.end();
    }
