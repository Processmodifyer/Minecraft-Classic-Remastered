package net.classic.remastered.game.entity;

import net.classic.remastered.client.model.ModelManager;
...
public class LivingEntity extends Entity {
	...
	// texture of mob (can crash game if is invalid or missing texture, see mob/ folder for textures, must be in png format.)
	protected String textureName = "/char.png";
	public boolean allowAlpha = true;
	public float rotOffs = 0.0F;
	// Crashes or Hangs game if are invalid Model, RenderlivingAI
	public String modelName = null;
	// Bob Zombie, Ha ha. (is joke), strength of mob.
	protected float bobStrength = 1.0F;
	// score of mob
	protected int deathScore = 0;
    // render offset (Warning:  can corrupt model if max value!)
	public float renderOffset = 0.0F;
	// health of mob, must be number.(0 = infinity)
